...
const perguntas = [
  ...
  "Recentemente, meus comportamentos compulsivos ou vícios me levaram a pensar seriamente em tirar minha própria vida ou me machucar.", // FLAG
  ...
  return (
    <div className="max-w-xl mx-auto p-6 bg-gray-100 dark:bg-gray-800 rounded-xl shadow-md">
      {!resultado ? (
        ...
        <>
          <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Resultado: {resultado}</h2>
          {resultado === "VERDE" && <p className="text-gray-800 dark:text-gray-200">Você lida muito bem com esse tema e está emocionalmente bem resolvido. Poderá auxiliar grandemente outras pessoas que precisam de ajuda.</p>}
          {resultado === "AMARELO" && <p className="text-gray-800 dark:text-gray-200">Há sinais evidentes de dificuldades emocionais que precisam ser trabalhadas e que, com determinação e ajuda, poderão ser superadas.</p>}
          {resultado === "VERMELHO" && <p className="text-gray-800 dark:text-gray-200">Seus problemas emocionais com este tema precisam necessariamente de ajuda profissional. Procure com brevidade a ajuda de um médico ou psicólogo.</p>}
          <button
